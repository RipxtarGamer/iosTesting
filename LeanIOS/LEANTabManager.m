...
- (UITabBarItem *)createOrUpdateTabBarItem:(UITabBarItem *)tabBarItem withTitle:(NSString *)title activeIcon:(NSString *)activeIcon inactiveIcon:(NSString *)inactiveIcon {
...
- (void)setTabBarItems:(NSArray*) menu {
    ...
    for (NSUInteger i = 0; i < [menu count]; i++) {
        ...
        UITabBarItem *item = [self createOrUpdateTabBarItem:nil withTitle:label activeIcon:activeIcon inactiveIcon:inactiveIcon];
...
-(void)traitCollectionDidChange:(UITraitCollection *)previousTraitCollection
{
    ...
    for (NSUInteger i = 0; i < [self.menu count]; i++) {
        ...
        [self createOrUpdateTabBarItem:item withTitle:label activeIcon:activeIcon inactiveIcon:inactiveIcon];
    }
}
